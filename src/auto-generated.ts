...
const externals = {
    ...
    '@youwol/fv-code-mirror-editors':
        "window['@youwol/fv-code-mirror-editors_APIv02']",
...
const entries = {
    ...
    ...Object.values(secondaryEntries).reduce(
        (acc, e) => ({
            ...acc,
            [`@youwol/vsf-snippet/${e.name}`]: e.entryFile,
        }),
        {},
    ),
}
export const setup = {
    ...
    developerDocumentation:
        'https://platform.youwol.com/applications/@youwol/cdn-explorer/latest?package=@youwol/vsf-snippet&tab=doc',
